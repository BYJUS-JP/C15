...
function preload() {
  ...
  jumpSound = loadsSound("jump.mp3");
  checkPointSound = loadsSound("checkPoint.mp3");
  dieSound = loadsSound("die.mp3");
...
function draw() {
  ...
  if(gameState === PLAY) {
    ...
    obstaclesGroup.setLifetimeEache(-1);
    cloudsGroup.setLifetimeEache(-1);
